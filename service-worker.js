const CACHE_NAME = 'web-arcade-v9';
const APP_FILES = ['./', 'index.html', 'styles.css', 'app.js', 'shared/arcade.css', 'shared/arcade.js', 'shared/stats.js', 'shared/achievements.js', 'manifest.webmanifest', 'icons/icon.svg', 'games/pong/', 'games/pong/index.html', 'games/pong/styles.css', 'games/pong/game.js'];
