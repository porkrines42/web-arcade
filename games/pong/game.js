(() => {
  ...
  function isPortraitPhone() { return isTouchDevice() && window.matchMedia('(orientation: portrait)').matches; }
  function enterGameView() {
    if (!isTouchDevice() || document.fullscreenElement || navigator.standalone || window.matchMedia('(display-mode: standalone)').matches) return;
